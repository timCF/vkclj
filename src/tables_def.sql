...
CREATE TABLE `vk_albums` (
  ...
  `stamp` bigint unsigned NOT NULL,
  PRIMARY KEY `id` (`id`),
  UNIQUE KEY `unkey` (`account_id`, `gid`, `aid`),
...
CREATE TABLE `vk_album_types` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_album_id` bigint unsigned NOT NULL, # target from vk_albums
  `type` varchar(10) NOT NULL,
  `access` boolean NOT NULL, # true - use items with this type, false - not
  PRIMARY KEY `id` (`id`),
  UNIQUE KEY `unkey` (`account_id`, `type`),
  KEY `access` (`access`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `vk_album_subtypes` (
  ...
  `access` boolean NOT NULL, # true - use items with this type, false - not
  PRIMARY KEY `id` (`id`),
  UNIQUE KEY `unkey` (`account_id`, `subtype`),
  KEY `access` (`access`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
